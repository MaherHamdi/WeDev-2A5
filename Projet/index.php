...
if(!empty($_SESSION['e']))
  ...
  if($res['verifier']==1)
 {
    ...
    header('Location:view/user_interface/welcome.php');
 } 
  }
?>
<!DOCTYPE html>
...
<?php include('view/user_interface/signup.php');?>

<?php include('view/user_interface/login.php');?>

<?php include('view/user_interface/header.php');?>
...
<!-- ======= Hero Section ======= -->
<?php include('view/user_interface/hero_section1.php');?>
<!-- End Hero -->


  <!-- ======= notre zoo Section ======= -->
  <?php include('view/user_interface/zoo_section.php');?>
  <!-- notre zoo Section -->
  ...
  <!-- ======= nouveauté Section ======= -->
  <?php include('view/user_interface/nouveaute_section.php');?>
 <!-- End nouveauté Section -->
  ...
  <!-- ======= Contact Section ======= -->
  <?php include('view/user_interface/contact.php');?>
<!-- End Contact Section -->
