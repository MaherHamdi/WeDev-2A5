        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="add-user.php" method="POST" autocomplete="">
                    ...
                    if (strpos($fullUrl, "error=champs") == true) {
                        $error="veuillez remplir tous les champs ";
                    }
                    if (strpos($fullUrl, "error=lowpassword") == true) {
                        $error="Le mot de passe doit comporter au moins 8 caractères ,et contenir un chiffre, une majuscule ";
                    }
                    ?>
                    <?php if ($error != "") { ?>
                    ...
                    ?>-->
                        <div class="form-group">
                            <input class="form-control " type="text" name="nom" placeholder="Nom"  value="<?php /* echo $name */ ?>">
                        </div>
                        <div class="form-group">
